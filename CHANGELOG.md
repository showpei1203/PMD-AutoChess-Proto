...
## v1.06.55 — Current Development Candidate (UNPASSED)
...
- Unsafe hard Landmark placement is rejected/relocated; sealed Gate 1 room/corridor topology is never rewritten.
...
- Windows/RMVX real-machine acceptance is still required.
