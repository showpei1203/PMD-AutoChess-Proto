# encoding: UTF-8
#===============================================================================
# ■ PMD AutoChess - Project State Sync Schema 4 v1.05.77
#-------------------------------------------------------------------------------
# 同步 v1.05.74-76：Rendered Banner Anchor、Hunt Lifecycle、Collection Info Data。
#===============================================================================
$imported={} unless defined?($imported)
$imported['PMD_AutoChess_ProjectStateSyncSchema4_v10577']=true
...
module PMD_AC
  class << self
    ...
    def write_project_state_log(force=false)
      ...
      lines << 'LATEST_FEATURE=SKILL_BANNER_RENDER_ANCHOR+HUNT_LIFECYCLE+COLLECTION_INFO_DATA'
      ...
      lines << 'NEXT_TARGET=HUNT_REGION_ECONOMY+RANDOM_MAP_EVENT_TEMPLATE+UI_DATA_CONTRACT'
